...
const plans = [
  {
    ...
    slug: 'starter',
    price: 29,
    limits: { maxStaff: 1, maxModules: 5, maxEntriesPerMonth: 500 },
    features: {
      maxStaff: 1, maxModules: 5, maxBranches: 1,
  ...
  },
  {
    ...
    slug: 'professional',
    price: 79,
    limits: { maxStaff: 1, maxModules: 20, maxEntriesPerMonth: 5000 },
    features: {
      maxStaff: 1, maxModules: 20, maxBranches: 3,
  ...
  },
  {
    ...
    slug: 'enterprise',
    price: 199,
    limits: { maxStaff: 1, maxModules: 999, maxEntriesPerMonth: 999999 },
    features: {
      maxStaff: 1, maxModules: 999, maxBranches: 50,
      analytics: true, reports: true, customModules: true,
